...
var About = React.createClass({
  ...
  render:function(){
    var {title, content, url_1,url_2,url_3,url_4,url_5,url_6,url_7,url_8} = this.state;
                      ...
                      <g id="_x33_">
                        <g>
                          ...
                          <g transform="matrix(1 0 0 1 -6.103516e-05 0)" style={{clipPath: 'url(#polygon-7)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(7)} style={{overflow: 'visible'}} width={600} height={600}
                        ...
                        <g>
                          ...
                          <g style={{clipPath: 'url(#polygon-8)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(8)} style={{overflow: 'visible'}} width={600} height={600}
                        ...
                        <g>
                          ...
                          <g transform="matrix(1 0 0 1 0 -1.525879e-05)" style={{clipPath: 'url(#polygon-5)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(5)} style={{overflow: 'visible'}} width={600} height={600}
                      ...
                      <g id="_x32_">
                        <g>
                          ...
                          <g style={{clipPath: 'url(#polygon-6)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(6)} style={{overflow: 'visible'}} width={600} height={600}
                        ...
                        <g>
                          ...
                          <g transform="matrix(1 0 0 1 0 -1.525879e-05)" style={{clipPath: 'url(#polygon-4)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(4)} style={{overflow: 'visible'}} width={600} height={600}
                        ...
                        <g>
                          ...
                          <g transform="matrix(1 0 0 1 -6.103516e-05 0)" style={{clipPath: 'url(#polygon-2)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(2)} style={{overflow: 'visible'}} width={600} height={600}
                      ...
                      <g id="_x31_">
                        <g>
                          ...
                          <g transform="matrix(1 0 0 1 0 -1.525879e-05)" style={{clipPath: 'url(#polygon-3)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(3)} style={{overflow: 'visible'}} width={600} height={600}
                        ...
                        <g>
                          ...
                          <g style={{clipPath: 'url(#polygon-1)'}}>
                            <image onMouseEnter={() => this.handlePolyClick(1)}  style={{overflow: 'visible'}} width={600} height={600}
